...
```sh
grep -rl 'memegenerator' ./ | xargs sed -i '' 's/memegenerator/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with memegenerator
...
Want to contribute? Ping us on `memegenerator` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/memegenerator.git
    cd memegenerator
    ```
...
- [memegenerator integration Documentation](https://docs.vuestorefront.io/memegenerator)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `memegenerator` channel on [our Discord](discord.vuestorefront.io).
